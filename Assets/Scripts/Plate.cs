...
public class Plate : MonoBehaviour
{
    ...
    /// </summary>
    protected static Plate mCurrentPlate;

    //Sound
    public AudioClip barreraSound;
    public static Plate currentPlate
    {
        get { return mCurrentPlate; }
        set
        {
            if (currentPlate != null && currentPlate.marker != null)
            {
                currentPlate.marker.SetActive(false);
            }
            ...
            if (currentPlate != null && currentPlate.marker != null)
            {
                currentPlate.marker.SetActive(true);
            }
        }
    }

    /// <summary>
    /// Object used to remark this lane/plate
    /// </summary>
    ...
    {
        StartCoroutine(PlaySound(barreraSound));
        ...
        {
            points += itemDestroyed.itemString.Length;
    ...
    private IEnumerator PlaySound(AudioClip soundName)
    {
        int repetitions = 2;
